	...
	<body>
		...
		<div class="container">
			<div class="offset-md-2 col-md-8">
				<div class="row">
					<div class="col-md-10">
						<form class="form-inline" id="from01" action="${pageContext.request.contextPath}/cartLogin" method="post">
					...
					<table class="table table-bordered">
						...
						<c:forEach items="${doctor}" var="d">
							<tr>
								...
								<td>${d.count}</td>
								<td>
									<a href="${pageContext.request.contextPath}/setNumberLogin?id=${d.id}">修改数量</a>
								</td>
							</tr>
						</c:forEach>
							<tr>
