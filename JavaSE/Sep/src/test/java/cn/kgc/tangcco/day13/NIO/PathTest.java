...
public class PathTest {
    ...
    public void test01() {
         ...
         */
        Path path1 = Paths.get("D:/dev/eclipse");
        System.out.println(path1);
        Path path2 = Paths.get("D:", "/dev", "/eclipse");
        System.out.println(path2);
        Path path3 = Paths.get("D:/dev", "/eclipse");
        System.out.println(path3);
        Path path4 = Paths.get("src/main/resources/笔记.txt");
        /**
         * 定义一个相对于根路径的相对路径 相对路径是全路径的一部分，相对路径通常用在创建web 页面中。 相对路径要比绝对路径用的更加广泛。
         * 在当前路径下保存一个相对路径通常要加上文件分隔符。
         */
        System.out.println(path4);
        Path path5 = Paths.get("src", "/main", "/resources", "/笔记.txt");
        System.out.println(path5);
        Path path6 = Paths.get("src/main/", "resources/笔记.txt");
        System.out.println(path6);
        /**
         * 定义一个相对于工作目录的相对路径,不用使用文件分隔符作为开始
         */
        Path path7 = Paths.get("src/main/resources/笔记.txt");
        System.out.println(path7);
        Path path8 = Paths.get("src", "main", "resources", "笔记.txt");
        System.out.println(path8);
        /**
         * 定义一个从URI获取的路径 在一些情况下，你需要从URI中创建一个路径， 你可以使用URI.create() 方法根据指定的字符串从URI中创建路径。
         */
        URI uri = URI.create("file://D:/dev/eclipse");
        Path path9 = Paths.get(uri);
        System.out.println(path9);

        /**
         * 用FileSystems.getDefault().getPath(String first, String... more) 方法来定义一个Path类。
         */
        Path path10 = FileSystems.getDefault().getPath("src/main/resources", "笔记.txt");
        System.out.println(path10);
        Path path11 = FileSystems.getDefault().getPath("src/main/./resources", "笔记.txt").normalize();
        System.out.println(path11);

        /**
         * 获取系统的主目录的路径
         */
        Path path12 = Paths.get(System.getProperty("user.home"));
        System.out.println("12 = " + path12);
        /**
